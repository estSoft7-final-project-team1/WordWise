...
public class WordBookController {
    ...
    public ResponseEntity<List<WordBookResponse>> getWordBooksByMember(@PathVariable Long memberId) {
    ...
    public ResponseEntity<List<WordBookResponse>> searchWordBook( @PathVariable Long memberId, @RequestParam String keyword) {
